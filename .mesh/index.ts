...
import type { OrderTypes } from './sources/Order/types';
import type { AttributeTypes } from './sources/Attribute/types';
...
export type MeshContext = OrderTypes.Context & ContractTypes.Context & AttributeTypes.Context & BaseMeshContext;
